...
for subj in subjlist:
    ...
    # Saving results
    np.save('Me_joint_cong', np.stack(all_scores))
    ...
    # Saving results
    np.save('Me_joint_incong', np.stack(all_scores))
    ...
    # Saving results
    np.save('Me_parallel_cong', np.stack(all_scores))
    ...
    # Saving results
    np.save('Me_parallel_incong', np.stack(all_scores))
...
for subj in subjlist:
    ...
    # Saving results
    np.save('Me_joint', np.stack(all_scores))
    ...
    # Saving results
    np.save('You_joint', np.stack(all_scores))
...
#%%
    ...
    # Saving results
    np.save('Me_parallel', np.stack(all_scores))
    ...
    # Saving results
    np.save('You_parallel', np.stack(all_scores))
